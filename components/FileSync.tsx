...
import { Table, TableCell, TableRow, TableColumn, Label, Icon, Panel, Title, Text, Input } from '@ui5/webcomponents-react';
    ...
    <div className='bg-slate-200 h-[90vh] p-2 overflow-hidden '>
        ...
        <div className='bg-white p-4 border border-gray-400 flex gap-4 rounded-b-lg'>
          ...
          <div className='h-[55vh] w-[50vw] border border-slate-400 rounded-lg p-3 shadow-md flex flex-col justify-evenly  items-stretch'>
                    ...
                    <Text>
                      <div className=' flex gap-5 justify-center text-xs p-1'>
                        <div className='flex-row'>
                          <div>
                            <span className='opacity-60'>ERP Username *</span> <br /> <Input className='h-[4vh] w-[8vw]'/>
                          </div>
                          <div className='mt-1'><span className='opacity-60'>ERP URL *</span> <br /> <Input className='h-[4vh] w-[8vw]'/></div>
                        </div>
                        
                        <div className='flex-row ml-5'>
                          <div><span className='opacity-60'>ERP Password *</span> <br /> <Input type='Password' className='h-[4vh] w-[8vw]'/></div>
                          <div className='mt-1'><span className='opacity-60'>BIP Report(s) Path *</span> <br /> <Input className='h-[4vh] w-[8vw]'/></div>
                        </div>
                      </div>
            ...
            <Table className='border border-slate-400 rounded-md' columns={<><TableColumn style={{width: '1rem'}}>Sl no</TableColumn><TableColumn popinText="Supplier">Data 
            Source 
