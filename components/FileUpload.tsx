		...
		<div className="flex justify-evenly">
			<div className=" h-[90vh] p-2 overflow-hidden ">
				...
				<div className=" p-4 border border-gray-400 flex gap-4 rounded-b-lg">
					<Table
						className="h-[55vh] border border-gray-400 rounded-md shadow-md"
						accessibleName=""
						columns={
							<>
						...
						<TableRow>
							...
							<TableCell>
								<Label>Roles_Details.xlxs</Label>
							</TableCell>
							<TableCell>
								<Label>11/01/2024 16:17:18</Label>
							</TableCell>
							<TableCell>
								<Label>Racktim Guin</Label>
							</TableCell>
							<TableCell>
								<Label>16/01/2024 22:30:48</Label>
							</TableCell>
							<TableCell>
								<Label>Subhagata Mondal</Label>
							</TableCell>
						...
						<TableRow>
							...
							<TableCell>
								<Label>05/01/2024 07:07:07</Label>
							</TableCell>
							<TableCell>
								<Label>Racktim Guin</Label>
							</TableCell>
							<TableCell>
								<Label>05/01/2024 12:46:55</Label>
							</TableCell>
							<TableCell>
								<Label>Subhagata Mondal</Label>
							</TableCell>
						...
						<TableRow>
							...
							<TableCell>
								<Label>Manager_Details.xlxs</Label>
							</TableCell>
							<TableCell>
								<Label>21/01/2024 10:17:46</Label>
							</TableCell>
			...
			<div className="pt-2 pr-1">
				...
				<div className="h-[45vh] w-[20vw] border border-slate-400 rounded-b-lg p-8 shadow-md">
